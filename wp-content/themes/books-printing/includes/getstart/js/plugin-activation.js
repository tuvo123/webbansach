jQuery(document).ready(function($) {
    'use strict';
    var this_obj = books_printing_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.books-printing-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message books-printing-plugin-install');
                button.addClass('button-primary books-printing-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.books-printing-recommended-plugins .books-printing-activation-note').css('display','block');
    ...
    $(document).on('click', '.books-printing-plugin-activate', function(event) {
